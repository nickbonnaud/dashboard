...
class OwnerFormState extends Equatable {
  ...
  factory OwnerFormState.empty({OwnerAccount? ownerAccount}) {
    return OwnerFormState(
      ...
      isFirstNameValid: ownerAccount != null,
      isLastNameValid: ownerAccount != null,
      isTitleValid: ownerAccount != null,
      isPhoneValid: ownerAccount != null,
      isEmailValid: ownerAccount != null,
      isPercentOwnershipValid: ownerAccount != null,
      isDobValid: ownerAccount != null,
      isSsnValid: ownerAccount != null,
      isAddressValid: ownerAccount != null,
      isAddressSecondaryValid: true,
      isCityValid: ownerAccount != null,
      isStateValid: ownerAccount != null,
      isZipValid: ownerAccount != null,
