...
class BankScreenState extends Equatable {
  ...
  factory BankScreenState.empty({required BankAccount bankAccount}) {
    return BankScreenState(
      ...
      isFirstNameValid: bankAccount.firstName.isNotEmpty,
      isLastNameValid: bankAccount.lastName.isNotEmpty,
      isRoutingNumberValid: bankAccount.routingNumber.isNotEmpty,
      isAccountNumberValid: bankAccount.accountNumber.isNotEmpty,
      isAddressValid: bankAccount.address.address.isNotEmpty,
      isAddressSecondaryValid: true,
      isCityValid: bankAccount.address.city.isNotEmpty,
      isStateValid: bankAccount.address.state.isNotEmpty,
      isZipValid: bankAccount.address.zip.isNotEmpty,
