          ...
          children: [
            ...
            BlocBuilder<NetSalesTodayBloc, NetSalesTodayState>(
              builder: (context, state) {
                if (state is Loading || state is NetSalesInitial) return const CircularProgressIndicator(key: Key("netSalesTodayCircularProgressKey"));
